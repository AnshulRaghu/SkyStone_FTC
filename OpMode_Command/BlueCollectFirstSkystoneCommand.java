...
public class BlueCollectFirstSkystoneCommand extends BaseCommand {
    ...
    public BlueCollectFirstSkystoneCommand(LinearOpMode opMode, HkRobot robot, Double desiredOrientationAngle) {
        super(opMode, robot);
    ...
    public void run() {
        ...
        if (rightBlueGreenRatio > BLUE_TO_GREEN_RATIO_THRESHOLD) {
            ...
            drivetrain.strafeLeft(0.4, 12, false, 0, true, 0, 0, 0, 0, true, desiredOrientationAngle, 0.02);
