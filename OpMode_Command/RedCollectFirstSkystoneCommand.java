...
public class RedCollectFirstSkystoneCommand extends BaseCommand {
    ...
    public RedCollectFirstSkystoneCommand(LinearOpMode opMode, HkRobot robot, Double desiredOrientationAngle) {
        super(opMode, robot);
    ...
    public void run() {
        ...
        if (leftBlueGreenRatio > BLUE_TO_GREEN_RATIO_THRESHOLD) {
            drivetrain.strafeLeft(0.4, 5, false, 0, true, 0, 0, 0, 0, true, desiredOrientationAngle, 0.02);
