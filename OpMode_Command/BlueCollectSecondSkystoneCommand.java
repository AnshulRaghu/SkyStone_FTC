...
public class BlueCollectSecondSkystoneCommand extends BaseCommand {
    private Claw claw;
    ...
    public BlueCollectSecondSkystoneCommand(LinearOpMode opMode, HkRobot robot, HkPosition skystonePosition, Double desiredOrientationAngle) {
        super(opMode, robot);
    ...
    public void run() {
        ...
        switch (skystonePosition) {
            ...
            default:
                ...
                moveUntilStoneCommand = new MoveUntilObjectCommand(opMode, robot, robot.getFrontRightDistanceSensor(), 6, 0.3, true, 6, 0, 0, 0, 0, true, desiredOrientationAngle, 0.02);
            ...
            case FOUR:
                ...
                // Move from the building zone to the loading zone
                drivetrain.strafeRight(0.9, 50, false, 0, false, 0.2, 10, 0, 0, true, desiredOrientationAngle, 0.08);
                ...
                drivetrain.strafeRight(0.5, distanceFromWall + 3, true, 1.5, true, 0, 0, 0, 0, true, desiredOrientationAngle, 0.02);
                sleepWithActiveCheck(10);
                ...
                drivetrain.strafeLeft(0.4, 8, false, 0, true, 0, 0, 0, 0, true, desiredOrientationAngle, 0.02);
//                break;
        }
    ...
    private void adjustRobotPositionUsingDistanceSensor(double targetDistance) {
        double currentDistance = robot.getRightDistanceSensor().getDistance(DistanceUnit.INCH);
        double distanceCorrection = targetDistance - currentDistance;

        if (distanceCorrection > 0) {
            drivetrain.strafeLeft(0.2, distanceCorrection, false, 0, true, 0, 0, 0, 0, true, desiredOrientationAngle, 0.02);
            sleepWithActiveCheck(50);
        }
    }
