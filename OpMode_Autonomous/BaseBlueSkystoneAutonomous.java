...
import com.hadronknights.ftc.opmode.command.BlueCollectFirstSkystoneCommand;
import com.hadronknights.ftc.opmode.command.BlueCollectSecondSkystoneCommand;
...
public abstract class BaseBlueSkystoneAutonomous extends BaseSkystoneAutonomous {
    ...
    protected void collectFirstSkystone() {
        ...
        // Move to quarry
        MoveUntilObjectCommand moveUntilObjectCommand = new MoveUntilObjectCommand(this, robot, robot.getFrontRightDistanceSensor(), 5, 0.5, false,
        ...
        BlueCollectFirstSkystoneCommand collectFirstSkystoneCommand = new BlueCollectFirstSkystoneCommand(this, robot, desiredOrientationAngle);
        ...
        MoveUntilObjectCommand moveUntilWallCommand = new MoveUntilObjectCommand(this, robot, robot.getBackDistanceSensor(), 25, -0.3, false, 0, 0, 0, 0, 0, true, desiredOrientationAngle, 0.02);
    ...
    protected void strafeToBuildingZoneForStonePlacement(double strafeDistance, double targetDistanceFromWall, double liftDistance) {
        ...
        drivetrain.strafeLeft(0.9, strafeDistance, false, 0, false, 0.2, 15, 0, 0, true, desiredOrientationAngle, 0.04);
        ...
        StrafeUntilObjectCommand strafeUntilWallCommand = new StrafeUntilObjectCommand(this, robot, robot.getLeftDistanceSensor(), targetDistanceFromWall, -0.9,
    ...
    protected void collectSecondSkystone(double distanceBuildingToLoadingZone) {
        ...
        BlueCollectSecondSkystoneCommand collectSecondSkystoneCommand = new BlueCollectSecondSkystoneCommand(this, robot, firstSkystonePosition, desiredOrientationAngle);
        collectSecondSkystoneCommand.run();

        robot.getStoneGuard().centerStone();

        // Retract from the Quarry after collecting the second Skystone
        MoveUntilObjectCommand retractFromQuarryCommand = new MoveUntilObjectCommand(this, robot, robot.getBackDistanceSensor(), 25.5, -0.6, false, 0, 8, -0.2, 21, -0.2, true, desiredOrientationAngle, 0.02);
